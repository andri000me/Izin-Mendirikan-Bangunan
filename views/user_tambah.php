                ...
                <div class="panel-body">
                    ...
                    <form class="form-horizontal" action="" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="text" name="nama" class="form-control" id="inputEmail3" placeholder="Example@email.com" required>
                            </div>
                        </div>
...
if($_POST){
  ...
  if ($level==1) {
    ...
    //buat sql
    $sql="INSERT INTO user VALUES ('','$username','$paswd','$email','$nama')";
    $query=  mysqli_query($koneksi, $sql) or die ("SQL Simpan bangunan Error");
    if ($query){
